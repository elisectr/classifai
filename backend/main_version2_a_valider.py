...
from dataset_management import get_random_images
...
def create_partie(partie: PartieAmis, db: Session = Depends(get_db)):
    # Sélectionner 20 images aléatoires pour la partie
    ...
    return {**db_partie.__dict__, "images": images}
...
def get_partie(partie_id: int, db: Session = Depends(get_db)):
    ...
    # Sélectionner 20 images pour la partie récupérée
    images = get_random_images()
    return {**partie.__dict__, "images": images}
